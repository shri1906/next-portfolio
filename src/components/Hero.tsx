      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          <div className="animate-pulse space-y-8 text-center">
            ...
            {/* Badge Skeleton */}
            <div className="mx-auto h-10 w-56 rounded-full bg-slate-200 dark:bg-slate-800" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <div className="h-14 w-44 rounded-lg bg-slate-200 dark:bg-slate-800" />
              <div className="h-14 w-44 rounded-lg bg-slate-200 dark:bg-slate-800" />
            </div>
            ...
            <div className="grid grid-cols-3 gap-8 pt-12 border-t border-slate-200 dark:border-slate-800">
              {[1, 2, 3].map((i) => (
                <div key={i} className="space-y-3">
                  <div className="mx-auto h-8 w-16 rounded bg-slate-200 dark:bg-slate-800" />
                  <div className="mx-auto h-4 w-20 rounded bg-slate-200 dark:bg-slate-800" />
                </div>
              ))}
            </div>
          </div>
          ...
          >
            ...
            <motion.div variants={item} className="space-y-6">
              ...
              <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
                A Full-Stack Web Developer crafting beautiful,
                performant web experiences with modern technologies.
                Specialized in React, Node.js, and creating seamless
                user journeys.
              </p>
            </motion.div>
